...
| [AR-js-org/AR.js](https://github.com/AR-js-org/AR.js) | ⭐ 5,988 | Image & location-based AR on the web |
...
| [KhronosGroup/glTF](https://github.com/KhronosGroup/glTF) | ⭐ — | glTF spec —KHR_audio_emitter / KHR_audio_graph / KHR_audio_environment PRs |
...
1. **Each episode issue** (#55, #56, #57) is seeded with the topics, GitHub issue links, and potential guests from this outline.
2. Contributors: add research notes, additional issue links, or guest suggestions as **comments** on the episode issues.
...
*Last updated: September 2026 · Research sourced from live GitHub issue analysis across 10+ AR/MR/Spatial Computing repositories.*